                                    ...
                                    <tr>
                                      <td><table width="720" border="0" align="center" cellpadding="0" cellspacing="2">
                                        <tr class="tr_tabla_interna">
                                          ...
                                          <td width="87">Débito<input name="principal1<?php echo $item5->getId(); ?>" type="checkbox" class="chekbox2" id="principal1<?php echo $item5->getId(); ?>" onclick="validar(<?php echo $item5->getId(); ?>,1);" value="<?php echo $item5->getId(); ?>" <?php if(($_SESSION['datos'][$cont] == $item5->getId()) && $_SESSION['tipo'][$cont] == "Débito"){ ?>checked="checked"<?php }?> /></td>
                                          <td width="88">Crédito<input name="principal2<?php echo $item5->getId(); ?>" type="checkbox" class="chekbox2" id="principal2<?php echo $item5->getId(); ?>"  onclick="validar(<?php echo $item5->getId(); ?>,2);" value="<?php echo $item5->getId(); ?>" <?php if(($_SESSION['datos'][$cont] == $item5->getId()) && $_SESSION['tipo'][$cont] == "Crédito"){ ?>checked="checked"<?php }?> /></td>
                                        </tr>
                                      </table></td>
                                    </tr>
                               <?php  $cont++;
