...
var pageNav="<ul class='simplePagerNav'>";for(i=1;i<=pageCounter;i++){if(i==options.currentPage){pageNav+="<n>Página: </n> &nbsp;&nbsp;<img border='0' height='20' id='atras' name='atras' src='http://localhost/www/prueba-tracs/modulo_financiero/images/btn_flecha_atras.png' width='30' /><li class='currentPage simplePageNav"+i+"'><a rel='"+i+"' href='#'>"+i+"</a></li>";}
else{pageNav+="<li class='simplePageNav"+i+"'><a rel='"+i+"' href='#'>"+i+"</a></li>";}}
pageNav+="<img border='0' height='20' id='atras' name='atras' src='http://localhost/www/prueba-tracs/modulo_financiero/images/btn_flecha_adelante.png' width='30' /></ul>";if(!options.holder){switch(options.pagerLocation)
