...
function validar(){
	...
	if(nombre == ""){
		alert('Digite los Nombres del Administrador del conjunto.');
	...
	if(apellido == ""){
		alert('Digite los Apellidos del Administrador del conjunto.');
	...
	if(cedula == ""){
		alert('Digite la Cedula del Administrador del conjunto.');
	...
	if(rut == ""){
		alert('Digite el Rut/Nit del Administrador del conjunto.');
	...
	if(telefono == ""){
		alert('Digite el Telefono del Administrador del conjunto.');
	...
	if(celular == ""){
		alert('Digite el Celular del Administrador del conjunto.');
	...
	if(direccion == ""){
		alert('Digite la Direccion del Administrador del conjunto.');
...
function OK2(){
	alert('Administrador del conjunto modificado con exito.');
}
  ...
  <table width="850" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr>
      <td height="40" colspan="2" align="center"><input name="agregar_propietario" type="submit" class="boton_general" style="width:160px" id="agregar_propietario" value="::: Guardar :::" />
        ...
        <input type="hidden" name="url" id="url" value="parametrizacion_administrador" />
        </td>
...
<div class="titulos" id="subtitulo">&gt;Parametrización Administrador del conjunto</div>
</body>
</html>
