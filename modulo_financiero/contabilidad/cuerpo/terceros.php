   ...
   <ul class="pagination1">
    ...
    ?>
          <li class="tr_tabla_interna"> 
                ...
                <input name="modificar_int" type="button" class="boton_modificar_int" id="modificar_int" value="Modificar" onclick="location.href='../modificar_tercero.php?id=<?php echo $item->getNodocumento();?>'"/>
