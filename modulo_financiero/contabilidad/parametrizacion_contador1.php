...
function validar(){
	...
	if(nombre == ""){
		alert('Digite los Nombres del contador.');
	...
	if(apellido == ""){
		alert('Digite los Apellidos del contador.');
	...
	if(cedula == ""){
		alert('Digite la Cedula del contador.');
	...
	if(rut == ""){
		alert('Digite el Rut/Nit del contador.');
	...
	if(telefono == ""){
		alert('Digite el Telefono del contador.');
	...
	if(celular == ""){
		alert('Digite el Celular del contador.');
	...
	if(direccion == ""){
		alert('Digite la Direccion del contador.');
