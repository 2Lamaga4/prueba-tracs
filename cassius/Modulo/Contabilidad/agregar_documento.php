...
function agregar_r(){
	...
	MM_openBrWindow('agregar_cuenta_afecta.php?sigla='+sigla+'&nombre='+nombre+'&descripcion='+descripcion,'AgregarPropietario','scrollbars=yes,width=1050px,height=540px')
}
...
<form id="form1" name="form1" method="post" action="php/action/addDocumento.php">
...
<div class="titulos" id="subtitulo">&gt; Agregar Documento</div>
</body>
</html>
