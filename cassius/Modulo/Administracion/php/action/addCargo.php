...
require_once('../dao/cargosDAO.php');
require_once('../entities/cargos.php');
...
$location = "location: ../../Parametrizacion/agregraCargo.php?OK=2";


$FuncionariosDAO = new CargoDao();
$funcionarios = new cargoEnti();

$funcionarios->setCargo($nombre);
$funcionarios->setDes($description);
$FuncionariosDAO->save($funcionarios);
header($location);
exit;
