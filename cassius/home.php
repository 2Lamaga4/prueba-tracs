...
?>
<link href="ModuloAdministrativo/Contabilidad/config/estilos_cassius.css" rel="stylesheet" type="text/css" />
<script src="ModuloAdministrativo/Contabilidad/Scripts/swfobject_modified.js"></script>
<script src="ModuloAdministrativo/Contabilidad/Scripts/bloqueo_clic_derecho.js"></script>
<script src="ModuloAdministrativo/Contabilidad/Scripts/globos_ayuda.js"></script>
</head>
...
<div id="logo">
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="590" height="215" id="FlashID" title="logo">
    <param name="movie" value="ModuloAdministrativo/Contabilidad/images/logo.swf" />
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="ModuloAdministrativo/Contabilidad/images/logo.swf" width="590" height="215">
      <!--<![endif]-->
      <param name="quality" value="high" />
      <param name="wmode" value="transparent" />
      <param name="swfversion" value="11.0.0.0" />
...
<div id="logueo">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
        <input style="width:90px;"name="Entrar" type="button" class="boton_redondo" id="Entrar" value="::: Entrar :::" onclick="location.href='ModuloAdministrativo/menu_home.php'"/></td>
    </tr>
  </table>
</div>
</form>
