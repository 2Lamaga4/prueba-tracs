          ...
          <td height="35" colspan="2" valign="top"><table width="900" border="0" align="center" cellpadding="0" cellspacing="2">
            ...
            ?> 
                <tr class="tr_tabla_interna">
                  ...
                  <td width="108" align="center" class="td_tabla_interna"><?php echo $item2->getDebito(); ?></td>
                  <td width="113" align="center" class="td_tabla_interna"><?php echo $item2->getCredito(); ?></td>
                </tr>
          <?php } ?>   
