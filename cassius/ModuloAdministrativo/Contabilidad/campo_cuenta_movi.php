...
<?php if(isset($id) != $n){ ?>
 <tr id="item_nuevo" class="tr_tabla_interna">
    ...
    <td align="center" class="td_tabla_interna"><input name="debito<?php echo $_REQUEST['n']; ?>" type="text" class="textarea_redondo2" id="debito<?php echo $_REQUEST['n']; ?>" style="width:80px;" onKeyUp="javascript:valida_debito(<?php echo $_REQUEST['n']; ?>); sumar_cuentas_d(<?php echo $_REQUEST['n']; ?>)" /></td>
    <td align="center" class="td_tabla_interna"><input name="credito<?php echo $_REQUEST['n']; ?>" type="text" class="textarea_redondo2" id="credito<?php echo $_REQUEST['n']; ?>" style="width:80px;" onKeyUp="javascript:valida_credito(<?php echo $_REQUEST['n']; ?>)"   /></td>
  </tr>
<?php } ?>
<?php } ?>
